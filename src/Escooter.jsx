            ...
            try {
                ...
                const mergedData = dataStatus.data.stations.map(status => {
                    ...
                    return {
                        ...
                        capacity: info ? info.capacity : "N/A"
                    };
                });
                        ...
                        <li key={station.station_id}>
                            <table>
                                <tbody>
                                    <tr>
                                        <td>{station.name}:</td>
                                        <td>{station.num_scooters_available}</td>
                                        <td>/</td>
                                        <td>{station.capacity}</td>
                                        <td>Scooters available</td>
                                        <td>
                                            <a href="https://divvybikes.com/" target="_blank" rel="noopener noreferrer">
